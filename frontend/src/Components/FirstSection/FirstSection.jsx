...
import Tech_Content from "../../pages/Technologies/Tech_Content";
import Vision_Content from "../../pages/Vision/Vision_Content";
import WhatWeDoContent from "../../pages/WhatWeDo/WhatWeDoContent";
          ...
          <div className="first_section main_content_page">
            ...
            <div className="main-text">
              ...
              <h3 className="subHeadingOne">
                One compromised prompt. One leaked API key. That's all it takes
                to expose your enterprise data.
              </h3>
